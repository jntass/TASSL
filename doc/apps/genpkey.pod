...
the EC parameters encode. the value maybe B<explicit> or B<named_curve>
...
Generate EC/SM2 key from parameters:
 openssl genpkey -algorithm ec -pkeyopt ec_paramgen_curve:SM2 -pkeyopt ec_param_enc:named_curve
