...
$crypto.=" crypto/sm2/sm2.h"; # unless $no_cnsm
$crypto.=" crypto/sm3/sm3.h"; # unless $no_cnsm
$crypto.=" crypto/sm4/sm4.h"; # unless $no_cnsm
...
sub is_valid
{
	...
	sub recognise
	{
		...
		if ($platforms) {
			...
			if ($keyword eq "CNSM" && $no_cnsm) { return 0; }
